...
{
    /// <summary>
    /// An ABSwitch for changing an object's color of an image component.
    /// </summary>
    [RequireComponent(typeof(Image))]
    public class ImageColorSwitch : ABSwitch
    {
        ...
        public bool loop = false;                                                       // sets the switch to loop between A and B
        ...
        public override void Switch()
        {
            if (state == SwitchState.atA || state == SwitchState.switchingToA)
            {
                ...
                float distFromFinish = Vector4.Distance(BColor, GetComponent<Image>().color);
                ...
                colorkeys[0].color = GetComponent<Image>().color;
                colorkeys[0].time = 0f;
                colorkeys[1].color = BColor;
                colorkeys[1].time = 1f;

                alphakeys[0].alpha = GetComponent<Image>().color.a;
                alphakeys[0].time = 0f;
                alphakeys[1].alpha = BColor.a;
                alphakeys[1].time = 1f;
            ...
            else if (state == SwitchState.atB || state == SwitchState.switchingToB)
            {
                ...
                float distFromStart = Vector4.Distance(AColor, GetComponent<Image>().color);
                float toatlDistance = Vector4.Distance(AColor, BColor);
